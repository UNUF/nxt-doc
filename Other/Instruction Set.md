...
| `draw_h`   | `T0_T1_K0_X3_X5_??` | hidden | 13                                                                                       |             |
...
| `qrcode`   | `T0 T1_K0_X3_X5_NE` | hidden | 7: `x_start, y_start, size, back_color, front_color, overlay_pic_id, text`               | Generates a QR code at runtime; similar capabilities as the QR code component. |
